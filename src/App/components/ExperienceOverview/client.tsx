...
import AtomicComponent, { AtomicState } from '../../../lib/atomicCCMS/_shared/Components/Abstract/AtomicComponent/client';
import AtomicRoutingComponent, { AtomicRoutingProps, AtomicRouteData } from '../../../lib/atomicCCMS/_shared/Components/Abstract/AtomicRoutingComponent/client';
import ComponentManager from '../../../lib/atomicCCMS/client/ComponentManager';
...
export interface ExperienceData extends AtomicRouteData {
    historyEntries : any[]
}

export interface ExperienceOverviewState extends AtomicState {
	visibleExperienceLevel : number
}

export default class ExperienceOverview extends AtomicRoutingComponent<AtomicRoutingProps<ExperienceData>, ExperienceOverviewState> {
    ...
    constructor(props: AtomicRoutingProps<ExperienceData>, context?: any) {
        super(props, context);
    ...
    render() {
        let experiences : any[] = [];
        for (let historyEntry of this.props.data.historyEntries) {
